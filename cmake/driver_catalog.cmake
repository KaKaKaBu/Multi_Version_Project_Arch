...
set(DRIVER_CATALOG_MISC
    ...
    ${TEMPLATE_ROOT}/drivers/misc/ir_remote.c
    ${TEMPLATE_ROOT}/drivers/misc/isd1820.c
)
...
# YYYH_001 — 智能药盒（APP_VERSION 1-24 条件编译）
driver_catalog_resolve_app_version(DRIVER_CATALOG_YYYH_001_VERSION _YYYH_001_UNUSED_LEGACY_VERSION 24)

set(DRIVER_CATALOG_YYYH_001
    ${TEMPLATE_ROOT}/drivers/displays/oled_font.c
    ${TEMPLATE_ROOT}/drivers/displays/oled_ssd1306.c
    ${TEMPLATE_ROOT}/drivers/sensors/ds1302_rtc.c
    ${TEMPLATE_ROOT}/drivers/sensors/e18_presence.c
...
if(DRIVER_CATALOG_YYYH_001_VERSION GREATER_EQUAL 5)
    list(APPEND DRIVER_CATALOG_YYYH_001 ${TEMPLATE_ROOT}/drivers/actuators/sg90.c)
endif()

if(DRIVER_CATALOG_YYYH_001_VERSION GREATER_EQUAL 10)
    list(APPEND DRIVER_CATALOG_YYYH_001 ${TEMPLATE_ROOT}/drivers/sensors/hx711.c)
endif()

if(DRIVER_CATALOG_YYYH_001_VERSION GREATER_EQUAL 15)
    list(APPEND DRIVER_CATALOG_YYYH_001 ${TEMPLATE_ROOT}/drivers/comm/tts_uart.c)
endif()

if(DRIVER_CATALOG_YYYH_001_VERSION GREATER_EQUAL 20)
    list(APPEND DRIVER_CATALOG_YYYH_001 ${TEMPLATE_ROOT}/drivers/sensors/dht11.c)
endif()

if(DRIVER_CATALOG_YYYH_001_VERSION EQUAL 2 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 6 OR
   DRIVER_CATALOG_YYYH_001_VERSION EQUAL 11 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 16 OR
   DRIVER_CATALOG_YYYH_001_VERSION EQUAL 21)
    list(APPEND DRIVER_CATALOG_YYYH_001 ${TEMPLATE_ROOT}/drivers/comm/jdy31_ble.c)
endif()

if(DRIVER_CATALOG_YYYH_001_VERSION EQUAL 3 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 4 OR
   DRIVER_CATALOG_YYYH_001_VERSION EQUAL 7 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 8 OR
   DRIVER_CATALOG_YYYH_001_VERSION EQUAL 9 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 12 OR
   DRIVER_CATALOG_YYYH_001_VERSION EQUAL 13 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 14 OR
   DRIVER_CATALOG_YYYH_001_VERSION EQUAL 17 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 18 OR
   DRIVER_CATALOG_YYYH_001_VERSION EQUAL 19 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 22 OR
   DRIVER_CATALOG_YYYH_001_VERSION EQUAL 23 OR DRIVER_CATALOG_YYYH_001_VERSION EQUAL 24)
    list(APPEND DRIVER_CATALOG_YYYH_001
        ${TEMPLATE_ROOT}/drivers/comm/esp8266_wifi.c
        ${TEMPLATE_ROOT}/drivers/comm/esp8266_mqtt.c
    )
endif()

# AQMJ_001 — 智能门禁（APP_VERSION 1-18，51 版本 17 暂不接入）
driver_catalog_resolve_app_version(DRIVER_CATALOG_AQMJ_001_VERSION _AQMJ_001_UNUSED_LEGACY_VERSION 15)

set(DRIVER_CATALOG_AQMJ_001
    ${TEMPLATE_ROOT}/drivers/displays/oled_font.c
    ${TEMPLATE_ROOT}/drivers/displays/oled_ssd1306.c
    ${TEMPLATE_ROOT}/drivers/sensors/ds1302_rtc.c
    ${TEMPLATE_ROOT}/drivers/sensors/e18_presence.c
...
if(DRIVER_CATALOG_AQMJ_001_VERSION GREATER_EQUAL 6 AND DRIVER_CATALOG_AQMJ_001_VERSION LESS_EQUAL 16)
    list(APPEND DRIVER_CATALOG_AQMJ_001
        ${TEMPLATE_ROOT}/drivers/sensors/gl5506_light.c
        ${TEMPLATE_ROOT}/drivers/actuators/relay.c
    )
endif()

if(DRIVER_CATALOG_AQMJ_001_VERSION GREATER_EQUAL 11 AND DRIVER_CATALOG_AQMJ_001_VERSION LESS_EQUAL 15)
    list(APPEND DRIVER_CATALOG_AQMJ_001 ${TEMPLATE_ROOT}/drivers/misc/isd1820.c)
endif()

if(DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 2 OR DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 7 OR DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 12)
    list(APPEND DRIVER_CATALOG_AQMJ_001 ${TEMPLATE_ROOT}/drivers/comm/jdy31_ble.c)
endif()

if(DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 3 OR DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 4 OR
   DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 8 OR DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 9 OR
   DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 13 OR DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 14)
    list(APPEND DRIVER_CATALOG_AQMJ_001
        ${TEMPLATE_ROOT}/drivers/comm/esp8266_wifi.c
        ${TEMPLATE_ROOT}/drivers/comm/esp8266_mqtt.c
    )
...
if(DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 5 OR DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 10 OR DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 15)
    list(APPEND DRIVER_CATALOG_AQMJ_001
        ${TEMPLATE_ROOT}/drivers/comm/esp8266_wifi.c
        ${TEMPLATE_ROOT}/drivers/comm/esp8266_mqtt.c
    )
...
if(DRIVER_CATALOG_AQMJ_001_VERSION EQUAL 18)
    set(DRIVER_CATALOG_AQMJ_001
        ${TEMPLATE_ROOT}/drivers/displays/oled_font.c
        ${TEMPLATE_ROOT}/drivers/displays/oled_ssd1306.c
        ${TEMPLATE_ROOT}/drivers/misc/key.c
