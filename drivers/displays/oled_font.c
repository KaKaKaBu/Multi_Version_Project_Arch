/**
 * @file oled_font.c
 * @brief 6x8 ASCII bitmap font table and glyph lookup for OLED displays.
 *
 * Auto-generated by tools/gen_oled_font.py. Do not edit manually.
 * Source: builtin 6x8, cell 6x8, ASCII 0x20-0x7E.
 */

#include "oled_font.h"

/** @brief First printable ASCII code point in the font table (space). */
#define OLED_FONT_FIRST_CHAR 0x20U
/** @brief Last printable ASCII code point in the font table (~). */
#define OLED_FONT_LAST_CHAR  0x7EU
/** @brief Number of glyphs from FIRST_CHAR through LAST_CHAR inclusive. */
#define OLED_FONT_CHAR_COUNT 95U
/** @brief Glyph width in pixels. */
#define OLED_FONT_WIDTH      6U
/** @brief Glyph height in pixels. */
#define OLED_FONT_HEIGHT     8U
/** @brief Bytes stored per vertical page column within one glyph. */
#define OLED_FONT_COL_BYTES  1U
/** @brief Total bytes per glyph bitmap in oled_font_table. */
#define OLED_FONT_GLYPH_SIZE 6U

/** @brief Glyph bitmap table indexed by (ASCII code - 0x20). */
static const uint8_t oled_font_table[OLED_FONT_CHAR_COUNT][OLED_FONT_GLYPH_SIZE] = {
    /* 0x20 ' ' */
