...
{
    switch (prescaler) {
    case SPI_HAL_PRESCALER_DEFAULT:
        return SPI_BaudRatePrescaler_8;
    case SPI_HAL_PRESCALER_2:
        return SPI_BaudRatePrescaler_2;
    case SPI_HAL_PRESCALER_4:
        return SPI_BaudRatePrescaler_4;
    case SPI_HAL_PRESCALER_8:
        return SPI_BaudRatePrescaler_8;
    case SPI_HAL_PRESCALER_16:
        return SPI_BaudRatePrescaler_16;
    case SPI_HAL_PRESCALER_32:
        return SPI_BaudRatePrescaler_32;
    case SPI_HAL_PRESCALER_64:
        return SPI_BaudRatePrescaler_64;
    case SPI_HAL_PRESCALER_128:
        return SPI_BaudRatePrescaler_128;
    case SPI_HAL_PRESCALER_256:
...
hal_status_t spi_hal_init(uint8_t bus_id, const spi_hal_config_t *cfg)
{
    ...
    runtime->instance = SPIx;
    runtime->timeout_us = (cfg->timeout_us == 0U) ? SPI_HAL_DEFAULT_TIMEOUT_US : cfg->timeout_us;
    runtime->configured = 1U;
#if HAL_SPI_ENABLE_DMA
    runtime->dma_busy = 0U;
    runtime->tx_dma_channel = stm32f1_dma_channel(cfg->tx_dma_channel);
    runtime->rx_dma_channel = stm32f1_dma_channel(cfg->rx_dma_channel);
#endif
