...
/** @brief HAL_USART_ID_2 baud rate (JDY-31 BLE). */
#define BOARD_USART2_BAUDRATE 9600U
/** @brief HAL_USART_ID_3 baud rate (ESP8266). */
...
/* -------------------------------------------------------------------------- */
/* MQ135 空气质量传感器：HAL_ADC_ID_1 PA0。                                             */
/* -------------------------------------------------------------------------- */
#if HAL_ADC_ENABLE
#define BOARD_ADC_INSTANCE HAL_ADC_ID_1
#define BOARD_MQ135_ADC_CHANNEL HAL_ADC_CH_0
static const hal_pin_t board_mq135_adc_pin = { HAL_PORT_A, HAL_PIN_0, GPIO_HAL_MODE_ANALOG };

/* MQ-7 CO 传感器：HAL_ADC_ID_1 PA1。 */
#define BOARD_MQ7_ADC_CHANNEL HAL_ADC_CH_1
static const hal_pin_t board_mq7_adc_pin = { HAL_PORT_A, HAL_PIN_1, GPIO_HAL_MODE_ANALOG };
#endif
...
/* 排风扇继电器：PA4。                                                          */
/* -------------------------------------------------------------------------- */
static const hal_pin_t board_relay_pin = { HAL_PORT_A, HAL_PIN_4, GPIO_HAL_MODE_OUT_PP };
...
/* -------------------------------------------------------------------------- */
/* ESP8266 WiFi：v2 使用 HAL_USART_ID_3 PB10/PB11，CH_PD/RST 用 PB0/PB1。              */
/* -------------------------------------------------------------------------- */
