...
#endif
/** @brief ESP8266 USART TX pin (PB10, AF push-pull). */
static const hal_pin_t board_esp8266_tx = { GPIOB, GPIO_Pin_10, GPIO_HAL_MODE_AF_PP };
/** @brief ESP8266 USART RX pin (PB11, floating input). */
...
#define BOARD_ESP8266_MQTT_SUB_TOPIC "KQZL3/cmd"
#define BOARD_ESP8266_MQTT_PUB_TOPIC "KQZL3/telemetry"
...
/** @brief Relay/Fan drive pin (PA11, push-pull). */
static const hal_pin_t board_relay_pin = { GPIOA, GPIO_Pin_11, GPIO_HAL_MODE_OUT_PP };
/** @brief Status LED/Light pin (PB3, push-pull). */
static const hal_pin_t board_led_pin = { GPIOB, GPIO_Pin_3, GPIO_HAL_MODE_OUT_PP };
/** @brief Buzzer drive pin (PA8, push-pull). */
