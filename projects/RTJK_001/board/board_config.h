...
/* DS18B20 PA1 (V4+)                                                            */
/* -------------------------------------------------------------------------- */
static const hal_pin_t board_ds18b20_pin = { HAL_PORT_A, HAL_PIN_1, GPIO_HAL_MODE_OUT_OD };

/* -------------------------------------------------------------------------- */
/* MSP20 ADC PA0 (V8+)                                                          */
/* -------------------------------------------------------------------------- */
#if HAL_ADC_ENABLE
static const hal_pin_t board_msp20_adc_pin = { HAL_PORT_A, HAL_PIN_0, GPIO_HAL_MODE_ANALOG };
#define BOARD_ADC_INSTANCE HAL_ADC_ID_1
#define BOARD_MSP20_ADC_CHANNEL HAL_ADC_CH_0
...
/* -------------------------------------------------------------------------- */
/* ESP8266 HAL_USART_ID_3 (V3/V6/V10)                                                   */
/* -------------------------------------------------------------------------- */
...
/* -------------------------------------------------------------------------- */
/* JDY31 BLE HAL_USART_ID_2 (V2/V5)                                                     */
/* -------------------------------------------------------------------------- */
