/**
 * @file board_config.h
 * @brief KQZL2 board pin map, peripheral instances, and HAL feature overrides.
 */

/* KQZL2 板级配置：集中定义传感器、执行器、通讯端口和 MQTT 参数。 */
...
#define BOARD_ESP8266_MQTT_CLIENT_ID "KQZL2"
#define BOARD_ESP8266_MQTT_USER "yskj"
#define BOARD_ESP8266_MQTT_PASS "yskj@123"
#define BOARD_ESP8266_MQTT_SUB_TOPIC "KQZL2"
#define BOARD_ESP8266_MQTT_PUB_TOPIC "KQZL2/web"
#endif
...
#define BOARD_ESP8266_HUAWEI_DEVICE_SECRET "KQZL2_stm32"
#define BOARD_ESP8266_HUAWEI_SERVICE_ID "KQZL2"
...
#define BOARD_ESP8266_HUAWEI_CUSTOM_PUB_TOPIC "/jiabailie/M2M/KQZL2_stm32/up"
#define BOARD_ESP8266_HUAWEI_CUSTOM_SUB_TOPIC "/jiabailie/M2M/KQZL2_stm32/down"
#endif
...
static const hal_pin_t *const board_KQZL2_key_pins[] = {
    &board_key1_pin,
    &board_key2_pin,
    &board_key3_pin,
    &board_key4_pin
};
#define KEY_DRIVER_PIN_TABLE board_KQZL2_key_pins
#define KEY_DRIVER_BUTTON_COUNT ((uint8_t)(sizeof(board_KQZL2_key_pins) / sizeof(board_KQZL2_key_pins[0])))
