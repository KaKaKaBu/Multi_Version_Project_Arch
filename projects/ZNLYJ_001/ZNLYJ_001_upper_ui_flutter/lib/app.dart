...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    service = ZnlyjService(transport: transport, capabilities: capabilities);
        ...
        children: [
          ...
          Expanded(
            child: IndexedStack(
              index: _idx,
              children: [
                ZnlyjDashboard(service: service),
                ZnlyjSettings(service: service),
              ],
            ),
          ),
        ],
