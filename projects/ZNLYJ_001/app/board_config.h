...
/* DHT11 温湿度：PA0 单总线。                                                    */
/* -------------------------------------------------------------------------- */
static const hal_pin_t board_dht11_pin = { GPIOA, GPIO_Pin_0, GPIO_HAL_MODE_OUT_OD };
...
#define BOARD_GL5506_ADC_CHANNEL ADC_Channel_1
static const hal_pin_t board_gl5506_adc_pin = { GPIOA, GPIO_Pin_1, GPIO_HAL_MODE_ANALOG };
#endif
#endif
...
static const hal_pin_t board_e18_pir1_pin = { GPIOB, GPIO_Pin_2, GPIO_HAL_MODE_IN_PULLUP };

/* -------------------------------------------------------------------------- */
/* 红外衣物检测：PB3。                                                           */
/* -------------------------------------------------------------------------- */
#define BOARD_IR_CLOTHES_ACTIVE_LOW 0
static const hal_pin_t board_ir_clothes_pin = { GPIOB, GPIO_Pin_3, GPIO_HAL_MODE_IN_PULLUP };

/* -------------------------------------------------------------------------- */
/* 步进电机：PA4/PA5/PA6/PA7 控制晾衣架开合。                                   */
/* -------------------------------------------------------------------------- */
static const hal_pin_t board_stepmotor_a_pin = { GPIOA, GPIO_Pin_4, GPIO_HAL_MODE_OUT_PP };
static const hal_pin_t board_stepmotor_b_pin = { GPIOA, GPIO_Pin_5, GPIO_HAL_MODE_OUT_PP };
static const hal_pin_t board_stepmotor_c_pin = { GPIOA, GPIO_Pin_6, GPIO_HAL_MODE_OUT_PP };
static const hal_pin_t board_stepmotor_d_pin = { GPIOA, GPIO_Pin_7, GPIO_HAL_MODE_OUT_PP };
...
/* -------------------------------------------------------------------------- */
/* ESP8266 WiFi：v4 使用 USART3 PB10/PB11，CH_PD/RST 用 PB0/PB1。              */
/* -------------------------------------------------------------------------- */
