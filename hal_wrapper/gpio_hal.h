...
void gpio_hal_set_mode(hal_gpio_port_t port, hal_gpio_pin_t pin, gpio_hal_mode_t mode);
void gpio_hal_write(hal_gpio_port_t port, hal_gpio_pin_t pin, uint8_t value);
uint8_t gpio_hal_read(hal_gpio_port_t port, hal_gpio_pin_t pin);
void gpio_hal_toggle(hal_gpio_port_t port, hal_gpio_pin_t pin);
